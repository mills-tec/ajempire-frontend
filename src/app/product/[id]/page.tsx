...
export default function ProductDetailPage() {
  ...
  const resolvedFinalPrice = item?.flashSales
    ? calcDiscountPrice(resolvedCartPrice, item.flashSales.discountValue!, item.flashSales.discountType!)
    : resolvedCartPrice;
