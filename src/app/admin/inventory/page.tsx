            ...
            if (response.message) {
                ...
                const transformedProduct = {
                    ...
                    status: (product.productStatus === 'in stock'
                        ...
                        : 'Out of stock') as 'In-stock' | 'Low in stock' | 'Out of stock',
                            ...
                            <div className="overflow-x-auto scrollbar-hide">
                                <table className="w-full text-left border-collapse min-w-[1000px]">
                                    ...
                                    <tbody className="divide-y divide-gray-50">
                                        {filteredProducts.length === 0 && <EmptyTable tableType='Products' searchTerm={searchTerm} colSpan={10} />}
                                    ...
                                    <form id="edit-product-form" className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                name="category"
                                                defaultValue={
                                                    selectedProduct?.fullProduct?.category
                                                        ? typeof selectedProduct.fullProduct.category === 'object'
                                                            ? selectedProduct.fullProduct.category._id
                                                            : selectedProduct.fullProduct.category
                                                        : selectedProduct?.fullProduct?.categoryId
                                                }
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand_pink focus:border-brand_pink"
                                                required
                                            >
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    step="0.01"
                                                    min="0"
                                                    defaultValue={selectedProduct?.fullProduct?.weight}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand_pink focus:border-brand_pink"
                                                    required
                                                />
                                            </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium">{selectedProduct?.fullProduct?.weight ?? 'N/A'}</p>
                                            </div>
                                            <div>
                                            ...
                                            {/* ── Reviews — directly after Description, still inside the grid ── */}
                                            <div className="col-span-2">
                                                ...
                                                {reviewsLoading ? (
                                                    <div className="flex items-center justify-center py-6">
                                                        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-brand_pink" />
                                                    </div>
                                                ) : (selectedProduct?.reviews?.length ?? 0) === 0 ? (
                                                        ...
                                                        {selectedProduct?.reviews?.map((review) => (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-start gap-3 min-w-0">
                                                                    <div className="shrink-0 w-8 h-8 rounded-full bg-brand_pink/10 flex items-center justify-center">
                                                                        <span className="text-brand_pink text-xs font-bold uppercase">
                                                                ...
                                                                {/* Delete button */}
                                                                <button
                                                                    onClick={() => handleDeleteReview(review.user._id)}
                                                                    disabled={deletingReviewId === review.user._id}
                                                                    className="shrink-0 p-1.5 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                                                                    title="Delete review"
                                                                >
                                                                    {deletingReviewId === review.user._id ? (
