...
import { Search, Filter, Plus, MoreHorizontal, Eye, Edit2, Trash2, LayoutGrid, Boxes, AlertCircle, Star, ShoppingCart, Folder, Package, X, Loader2 } from 'lucide-react';
import Image from 'next/image';
import { getAllCategories, getProducts, deleteProduct, updateProduct, getProductById } from '@/lib/adminapi';
