...
import { Search, Filter, Eye, Trash2, ChevronLeft, ChevronRight, Users, TrendingUp, Package, MoreHorizontal, Mail, Phone, Calendar, X, AlertCircle, Loader2, UserCheck, UserX } from 'lucide-react';
import { getCustomers, deleteCustomer, updateCustomerStatus, toggleCustomerStatus } from '@/lib/adminapi';
import { useToast, ToastContainer } from '@/app/components/ui/Toast';
import { filterByPeriod, getPeriodStartDate } from '@/lib/dashboard-utils';
