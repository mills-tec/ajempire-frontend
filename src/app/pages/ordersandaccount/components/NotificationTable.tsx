                ...
                {tabs.map((tab) => (
                    <li key={tab.path}>
                        <Link
                            ...
                            {tab.name}
                            {pathname === tab.path && (
                                <span className={` absolute   -translate-x-6  bottom-0 w-5 border-b-4 border-primaryhover rounded-full ${pathname === "/pages/ordersandaccount/notifications/flashsale" ? "lg:left-10 left-10" : pathname === "/pages/ordersandaccount/notifications/order" ? "lg:left-8 left-7" : pathname === "/pages/ordersandaccount/notifications/system" ? "lg:left-10 left-10" : "lg:left-5 left-5"}`}>
                                </span>
                            )}
                        </Link>
                    </li>
