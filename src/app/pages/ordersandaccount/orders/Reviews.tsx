  ...
  return (
    products?.length > 0 ? (
      <div className="min-h-fit md:p-6 rounded-xl my-8  bg-white">
        ...
        <div
          className={`fixed bg-black/20 w-full h-screen top-0 left-0 backdrop-blur-[2px] z-[1000] px-10 md:px-0 flex justify-center font-poppins items-center ${showOverlay ? "scale-100" : "scale-0 delay-100"
            }`}
        >
          <div
            className={` ${reviewSuccess
              ...
              }  bg-white md:w-[60%] p-10   ${showOverlay ? "scale-100 delay-100" : "scale-0"
              }`}
          >
            {reviewSuccess ? (
              <>
