        ...
        <RefreshWrapper>
          ...
          <div className="mt-[6rem] lg:mt-0">
            ...
            <div className="flex gap-2 lg:h-auto">
                ...
                {data?.message?.map((cat) => {
                  ...
                  return (
                    <Link
                      ...
                      className={` flex flex-col gap-1 px-3 py-2 text-sm capitalize rounded-md transition ${
                        activeId === slug
                          ? "bg-[#F6E6FF] text-black"
                          : "hover:bg-gray-100"
                      }`}
                      onClick={clearSearch}
                    >
              ...
              {/* PRODUCTS */}
              <div className="lg:w-full flex-1 px-2 py-1 lg:h-0 h-[600px] overflow-y-auto scrollbar-hide">
                {children}
              </div>
            </div>
          </div>
