  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const res = axios.post(
        "https://ajempire-backend-production.up.railway.app/api//return",
        {
          formData,
          headers: {
      ...
      <div className="h-[550px] overflow-y-scroll">
        <div className="bg-white w-full lg:w-[600px]  rounded-t-lg lg:rounded-lg p-6 flex flex-col gap-6">
          <div className="flex justify-between items-center">
            ...
            >
              <path
                d="M7.32031 18.6801L13.0002 13.0002L18.6801 18.6801M18.6801 7.32031L12.9991 13.0002L7.32031 7.32031"
                stroke="black"
                strokeWidth="1.5"
                strokeLinecap="round"
          ...
          <div>
            ...
            <div className="flex items-center border border-gray-200 w-[200px] h-[40px] rounded-sm overflow-hidden">
              <span className="px-3 bg-gray-100 text-gray-600 text-sm">
                +234
              </span>
