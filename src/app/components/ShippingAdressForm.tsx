        ...
        <div className="fixed inset-0  bg-[#FFFFFF] flex lg:items-center items-start   lg:justify-center  z-50">
            ...
            <div className="w-full relative lg:shadow-lg font-poppins text-[14px] lg:w-[50%] lg:h-[500px] h-[600px] lg:px-10 px-5 py-8 overflow-y-scroll">
                ...
                <div className="lg:hidden flex items-center justify-between gap-1 mb-5">
                    ...
                    <div className="flex items-center gap-1">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12Z" fill="#AEAEAE" />
                ...
                <form action="" className="text-[#292929] flex flex-col lg:gap-4 gap-3" onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="border border-gray-300 focus-within:border-primaryhover rounded-sm w-full h-[40px] flex items-center p-3 transition-all duration-300">
                            <input type="text" placeholder="Enter First Name" className="w-full placeholder:text-[14px] text-[13px] outline-none" required value={fullName} onChange={(e) => setFullName(e.target.value)} />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                    ...
                    <button
                        className={`w-full bg-primaryhover text-white rounded-sm h-[40px] ${(!fullName || !phone || !street || !city || !selectedState || !selectedCountry || !postalCode) ? 'opacity-50 cursor-not-allowed' : ''}`}
                        disabled={!fullName || !phone || !street || !city || !selectedState || !selectedCountry || !postalCode}
                    >
                        Continue
                    </button>
                </form>

                <div className="absolute top-9 right-6 cursor-pointer " onClick={() => {
