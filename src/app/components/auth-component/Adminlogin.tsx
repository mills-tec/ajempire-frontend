        ...
        <div className="font-poppins  bg-white text-center flex flex-col items-center gap-6 p-10 rounded-lg shadow-lg justify-between">
            ...
            <div className="flex flex-col items-center gap-6">
                ...
                <div>
                    ...
                    <p className="text-[14px] font-normal text-[#8B8D97]">Login to your account</p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex flex-col gap-1">
                        ...
                        {!isValidEmail && emailinput && (
                            <p className="text-red-500 text-xs text-left pl-3 ">Enter a valid email</p>
                        )}
                    </div>
                    ...
                    <div className="flex relative flex-col gap-1">
                        <div className="bg-[#EFF1F9] flex items-center gap-1 w-full rounded-lg px-3">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.4234 9.44756V7.30056C16.4234 4.78756 14.3854 2.74956 11.8724 2.74956C9.35937 2.73856 7.31337 4.76656 7.30237 7.28056V7.30056V9.44756" stroke="#6E7079" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M15.6832 21.2495H8.04218C5.94818 21.2495 4.25018 19.5525 4.25018 17.4575V13.1685C4.25018 11.0735 5.94818 9.37646 8.04218 9.37646H15.6832C17.7772 9.37646 19.4752 11.0735 19.4752 13.1685V17.4575C19.4752 19.5525 17.7772 21.2495 15.6832 21.2495Z" stroke="#6E7079" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M11.8629 14.2026V16.4236" stroke="#6E7079" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <input
                                ...
                                {showPassword ? (
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_4379_20244)">
                                            <path d="M6.60002 2.82652C7.05891 2.71911 7.52873 2.66541 8.00002 2.66652C12.6667 2.66652 15.3334 7.99985 15.3334 7.99985C14.9287 8.75693 14.4461 9.46968 13.8934 10.1265M9.41335 9.41319C9.23025 9.60969 9.00945 9.76729 8.76412 9.8766C8.51879 9.98591 8.25395 10.0447 7.98541 10.0494C7.71687 10.0542 7.45013 10.0048 7.20109 9.90418C6.95206 9.80359 6.72583 9.65387 6.53592 9.46396C6.346 9.27404 6.19628 9.04782 6.09569 8.79878C5.9951 8.54975 5.9457 8.283 5.95044 8.01446C5.95518 7.74592 6.01396 7.48108 6.12327 7.23575C6.23258 6.99042 6.39019 6.76962 6.58669 6.58652M11.96 11.9599C10.8204 12.8285 9.43276 13.3098 8.00002 13.3332C3.33335 13.3332 0.666687 7.99985 0.666687 7.99985C1.49595 6.45445 2.64611 5.10426 4.04002 4.03985L11.96 11.9599Z" stroke="black" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M0.666687 0.666504L15.3334 15.3332" stroke="black" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                                        </g>
                                        <defs>
                    ...
                    <div className="flex  justify-end">
                        <p className="text-[#FF008C] font-light text-[13px]">Recover Password</p>
                    </div>
                </div>
            </div>
            <div className="w-full">
                <button className={`bg-gradient-to-b from-primaryhover to-brand_solid_gradient w-full px-6 py-3 rounded-lg text-white text-[16px] font-medium ${!isFormValid || loading ? 'opacity-50 cursor-not-allowed' : 'hover:from-brand_solid_gradient hover:to-primaryhover transition-all duration-200'}`}
                    disabled={!isFormValid || loading} onClick={handleLogin}>
                    Login
                </button>
            </div>
        </div>
