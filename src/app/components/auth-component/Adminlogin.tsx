                    ...
                    <div className="flex relative flex-col gap-1">
                        <div className="bg-[#EFF1F9] flex items-center gap-1 w-full rounded-lg px-3">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.4234 9.44756V7.30056C16.4234 4.78756 14.3854 2.74956 11.8724 2.74956C9.35937 2.73856 7.31337 4.76656 7.30237 7.28056V7.30056V9.44756" stroke="#6E7079" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.6832 21.2495H8.04218C5.94818 21.2495 4.25018 19.5525 4.25018 17.4575V13.1685C4.25018 11.0735 5.94818 9.37646 8.04218 9.37646H15.6832C17.7772 9.37646 19.4752 11.0735 19.4752 13.1685V17.4575C19.4752 19.5525 17.7772 21.2495 15.6832 21.2495Z" stroke="#6E7079" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.8629 14.2026V16.4236" stroke="#6E7079" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <input
