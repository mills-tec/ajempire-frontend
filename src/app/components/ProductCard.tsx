...
export default function ProductCard({
  ...
  return (
    <section
      ...
      // className={`space-y-0 group text-left hover:shadow-sm hover:rounded-md hover:bg-white p-2 lg:w-[13rem] border border-transparent hover:border-black/10 w-full break-inside-avoid ${index % 2 === 0 ? "mt-0" : "mt-6"
      //   }`}
    ...
    >
      ...
      <Link href={`/product/${product._id}`}>
        <div
          // className={`relative h-[60%] lg:w-full lg:h-[14rem] w-full break-inside-avoid  rounded-sm overflow-hidden md:overflow-clip `}
          // className="relative w-full aspect-[3/4] lg:aspect-[5/5] rounded-sm overflow-hidden"
          className="relative w-full aspect-[3/4] lg:aspect-square rounded-sm overflow-hidden"
        >
          <Image
            ...
            className="object-cover transition-transform duration-300 ease-out group-hover:scale-105 lg:bg-[#f9f8f8] lg:p-2"
          />
        </div>
      </Link>
              ...
              {isInWishlist(product._id) ? (
                ...
                >
                  <g clipPath="url(#clip0_6_3)">
                    ...
                    />
                    <path
                      d="M3.14662 10.8687C2.68703 10.3804 2.32291 9.79925 2.07546 9.159C1.82801 8.51875 1.70218 7.83223 1.70531 7.13945C1.70531 5.73829 2.22577 4.39452 3.15219 3.40376C4.07861 2.41299 5.33511 1.85638 6.64527 1.85638C8.48177 1.85638 10.0858 2.92542 10.9343 4.51656H12.2361C12.6675 3.70739 13.2917 3.03492 14.0451 2.56764C14.7985 2.10035 15.6542 1.85493 16.5252 1.85638C17.8353 1.85638 19.0918 2.41299 20.0183 3.40376C20.9447 4.39452 21.4651 5.73829 21.4651 7.13945C21.4651 8.59385 20.884 9.93637 20.0238 10.8687L11.5852 19.881L3.14662 10.8687Z"
                      fill="#FF008C"
                    />
                  </g>
                  <defs>
