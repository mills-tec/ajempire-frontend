                ...
                !isLoading && responseData && showModal && (
                    <div className="fixed inset-0  bg-black/40 flex lg:items-center items-start   lg:justify-center  z-50">
                        ...
                        <div className="p-6  lg:h-[400px] h-screen bg-white rounded shadow text-center items-center flex flex-col ">
                            <div className="w-full flex justify-end items-center mb-6 cursor-pointer" onClick={() => setShowModal(false)}>
                                <p className="lg:hidden w-full text-[16px]">Payment Confirmation</p>
                                ...
                                <div className="flex flex-col items-center">
                                    <div className="mb-4">
                                        <svg width="100" height="100" viewBox="0 0 162 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M81 0C36.45 0 0 36.45 0 81C0 125.55 36.45 162 81 162C125.55 162 162 125.55 162 81C162 36.45 125.55 0 81 0ZM64.8 121.5L24.3 81L35.721 69.579L64.8 98.577L126.279 37.098L137.7 48.6L64.8 121.5Z" fill="#FF008C" />
                                        </svg>
                                    </div>
                                    <p className="mb-4 font-poppins">{responseData}</p>
                                </div>
                                <button
                                    onClick={() => router.push("/pages/ordersandaccount/orders/all")}
