  ...
  return (
    <div className="w-full px-5 ">
      ...
      <div className="w-full flex items-center justify-between ">
        {/* Shop Section */}
        <div className="">
          <h3 className="font-semibold mb-2 text-[#FFFFFF] font-poppins text-[14px]">
            Shop
          </h3>
          {categories?.map((cat) => (
            <button
              ...
              className="flex flex-col text-left text-[#FFFFFF] hover:opacity-80 transition-all duration-300 text-[14px]"
            >
              {cat.name}
            </button>
          ))}
        ...
        <div>
          <FooterRout
            ...
            links={[
              {
                name: "About Us",
                href: "/pages/ordersandaccount/settings/firstabout",
              },
              { name: "Careers", href: "/careers" },
              { name: "Partnerships", href: "#" },
              { name: "Vendor Opportunities", href: "#" },
              {
                name: "Contact",
                href: "/pages/ordersandaccount/support/contact",
              },
            ]}
          />
        </div>
        ...
        <div>
          <FooterRout
            title="Support"
            links={[
              { name: "Shipping & Returns", href: "/pages/support" },
              { name: "Track My Order", href: "/pages/support" },
              { name: "Privacy Policy", href: "/pages/support" },
              { name: "Terms & Conditions", href: "/pages/support" },
            ]}
          />
        </div>
        ...
        <div>
          ...
          <div className="text-[#FFFFFF]  transition-colors duration-300 text-[14px]">
            ...
            <div className="mt-4">
              <p>
                By subscribing you agree to with our <span>Privacy Policy</span>{" "}
                and provide
              </p>
