  ...
  return (
    <div className="flex items-start relative w-full px-4 lg:px-0">
      ...
      <div className="flex gap-x-2 w-full border-b border-b-black/30 lg:border-none pb-4">
        <div className="relative bg-gray-400 h-[7rem] lg:!h-[8.5rem] min-w-[7rem] lg:min-w-[8.5rem] w-[7rem] lg:w-[8.5rem] rounded-xl overflow-clip">
          <Image
        ...
        <div className="flex w-full flex-col justify-between">
          <div className="space-y-1">
            ...
            <div className="">
              ...
              <div className="flex gap-1">
                <div className="size-[1.6rem] bg-gray-300 rounded-sm" />
                <div className="size-[1.6rem] bg-gray-300 rounded-sm" />
                <div className="size-[1.6rem] bg-gray-300 rounded-sm" />
              </div>
            </div>
            ...
            <div className="flex text-xs w-max items-center gap-3 justify-between">
          ...
          <div className="space-x-2 flex items-baseline justify-between w-full mt-6">
            <div className="flex items-center gap-1">
              ...
              <p className="text-brand_pink text-sm">
