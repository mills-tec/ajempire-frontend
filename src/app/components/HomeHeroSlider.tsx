...
export default function HomeHeroSlider({
  ...
  return (
    <div
      className="relative z-0 w-full md:h-[250px] h-[150px]  lg:h-[379px] bg-blue-200 overflow-hidden rounded-xl lg:rounded-3xl group"
                  ...
                  >
                    ...
                    <div className="bg-white rounded-2xl p-3 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 w-full">
                      <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                        ...
                        />
                        <div className="absolute  lg:top-2 lg:left-2 rounded-full bg-brand_pink px-3  py-1 lg:text-[13px] text-[8px] font-semibold uppercase  lg:tracking-[0.18em] text-white shadow-md">
                          Flashsale
                        </div>
                        {product.flashSales?.endDate && (
                          <div className="absolute inset-x-2 lg:text-[13px] text-[8px] bottom-1 rounded-full border border-brand_pink bg-black/55 px-2 py-1 text-center text-white backdrop-blur-[2px]">
                            <CountdownTimer
