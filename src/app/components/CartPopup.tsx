...
export default function CartPopup() {
  ...
  return (
    <div
      className="fixed bottom-0 flex items-end lg:items-start pb-[5rem] lg:pb-0 z-50 lg:justify-center h-full w-full bg-black/30 overflow-hidden"
      onClick={(e) => {
