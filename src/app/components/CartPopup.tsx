...
export default function CartPopup() {
  ...
  useEffect(() => {
    if (selectedItem) {
      ...
      requestAnimationFrame(() => setIsVisible(true)); // trigger fade-in
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            transform: isVisible ? "translateY(0%)" : "translateY(100%)", // slide up/down
          }}
          onClick={(e) => e.stopPropagation()}
      ...
      {/* <CheckoutRequirement setIsadress={setIsAdress} /> */}
      {/* {showCheckout && (
        <CheckoutRequirement
          setIsadress={(value) => {
