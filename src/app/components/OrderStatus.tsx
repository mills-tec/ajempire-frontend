    ...
    <div className="mt-8 w-max">
      <div className="flex gap-6">
        <div className="flex flex-col items-center w-max">
          ...
          >
            <g clip-path="url(#clip0_1629_9558)">
              <path
      ...
      <div className="flex gap-6">
        ...
        <div className="space-y-1">
          <h2 className="text-sm text-[#FF8D28]">Order Processing</h2>
          <h3 className="text-xs font-medium">Fri, 05 Aug 2025, 3:07am</h3>
          <p className="text-xs text-black/50">Your order is being Processed</p>
        </div>
      </div>
      <div className="flex gap-6">
        <div className="flex flex-col items-center w-max">
          ...
          >
            <circle cx="12" cy="12" r="12" />
            <g clip-path="url(#clip0_1629_9566)">
              <path
