...
export default function SelectedpaymentMethod() {
  ...
  console.log("Selected payment method: zustand:", selectedPaymentMethod);
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  return (
    <div className="w-full pt-6 font-poppins">
      ...
      <div className="space-y-4 w-full flex items-center flex-col">
        ...
        <div
          ...
          className={`w-full flex items-center justify-between border p-4 rounded-lg cursor-pointer ${
